...
export const TERMS_AND_CCONDITIONS: LegalInfoList = [
  {
    ...
    information: [
      "Mind Well is a mental health assessment application that provides users with personalized feedback based on their test inputs. The App is intended for informational and self-assessment purposes only and is not a substitute for professional mental health advice or treatment.",
    ],
  },
  {
  ...
  },
  {
    ...
    information: [
      "All intellectual property rights related to the App, including but not limited to copyrights, trademarks, and trade secrets, are owned by Mind Well. You are granted a limited, non-exclusive, and non-transferable license to use the App for personal, non-commercial purposes.",
    ],
  },
  {
    title: "Disclaimer",
    information: [
      "The App's content and information are provided \"as is,\" without any warranties, express or implied. Mind Well does not guarantee the accuracy, completeness, or reliability of the App's content or information. The App is not a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your qualified healthcare provider with any questions you may have regarding your mental health.",
    ],
  },
  {
    title: "Limitation of Liability",
    information: [
      "To the extent permitted by law, Mind Well shall not be liable for any direct, indirect, incidental, consequential, or special damages arising from or in connection with the use of the App or its content. This includes but is not limited to damages for loss of profits, data, or other intangible losses.",
    ],
  },
  {
    title: "Modifications",
    information: [
      "Mind Well reserves the right to modify these Terms at any time. Any changes will be effective immediately upon posting the updated Terms on the App. Your continued use of the App after the posting of the updated Terms constitutes your acceptance of the revised Terms.",
    ],
  },
  {
    title: "Governing Law",
