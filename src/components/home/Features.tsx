...
const FEATURES_CONTENT = [
  ...
  {
    title: "Discover Mind Well's Curated Resources",
    description:
...
function Features() {
  return (
    <motion.section
          ...
          <motion.li
            ...
            <div className="w-[160px] h-[160px] p-4 flex items-center justify-center mx-auto relative my-4">
              <img
                ...
                loading="lazy"
              />
              <div className="bg-secondary rounded-full w-[160px] h-[160px] group-hover:w-[500%] group-hover:h-[500%] bg-opacity-10 absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-1/2 z-0 transition-all duration-300" />
            </div>
      ...
      <p className="mt-4">
        With these features, MindCheck offers a comprehensive and user-friendly
        experience. Take the test, track your progress, and receive personalized
        feedback to support your mental health journey. Sign up or log in today
        to get started!
      </p>
    </motion.section>
  );
