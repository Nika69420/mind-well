...
const manifestForPlugin: Partial<VitePWAOptions> = {
  ...
  manifest: {
    name: "Mind Well",
    short_name: "Mind Well",
    description:
      "Mind Well is a free web application designed to assess and track your mental well-being. Take a variety of mental health tests, receive personalized feedback, and track your progress over time. Improve your mental well-being with Mind Well's AI-powered insights and resources.",
    theme_color: "#f1b5ac",
